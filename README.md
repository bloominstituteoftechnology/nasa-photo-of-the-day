...
- [ ] In `frontend/components/App.js` (or where ever you wanted to fetch the data) add state for the data you'll be getting from NASA.
...
- [ ] Using the endpoint given, fetch the data using `axios`, which is already installed in the project.
