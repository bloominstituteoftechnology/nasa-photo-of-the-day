...
- [x] If you want, this is the time to make a simple design spec (look up ["simple /wwireframes"](https:/ww.google.com/search?q=simple+wireframes) to find resources & examples). **A pen & paper sketch (or outline) is often the fastest way to start your planning.**
