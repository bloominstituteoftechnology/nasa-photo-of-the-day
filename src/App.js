...
// below is the 'axios call' to fetch the API with .get - .then, it will respond, by binding the Object Keys recieved from the API, to the setData Object.
  useEffect(() => {  // declare and invoke useEffect, which is a function
    axios.get("https://api.nasa.gov/planetary/apod?api_key=1XcrC3xroozQArT3QJTKfIW0acN4yfDqhwHVqWZm")  // API request from axios
  ...
  // below is the return of all the components linked to this App. The invocations are in <JSX /> form, and must declare the function needed =equal to= the API Keys' Value you want to use. 
