...
var ClockPointer$1 = styles$5.withStyles(styles$2, {
...
var Clock$1 = styles$5.withStyles(styles$3, {
...
var ModalDialog$1 = styles$5.withStyles(styles$4, {
  ...
  return React.createElement(rifm.Rifm, {
    ...
    return React.createElement(TextFieldComponent, _extends({
      ...
      InputProps: _extends({}, InputProps, _defineProperty({}, "".concat(position, "Adornment"), React.createElement(InputAdornment, _extends({
        position: position
      }, InputAdornmentProps), React.createElement(core.IconButton, _extends({
        disabled: disabled
      }, KeyboardButtonProps, {
        onClick: onClick
      }), keyboardIcon))))
