...
var Divider = _react.default.forwardRef(function Divider(props, ref) {
  var _props$absolute = props.absolute,
      ...
      other = (0, _objectWithoutProperties2.default)(props, ["absolute", "classes", "className", "component", "light", "role", "variant"]);
  return _react.default.createElement(Component, (0, _extends2.default)({
    className: (0, _clsx.default)(classes.root, className, absolute && classes.absolute, light && classes.light, {
      inset: classes.inset,
